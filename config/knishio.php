...
return [
    ...
    'laravel_model_caching' => [

        'cache-prefix' => '',
        'disabled'     => \env( 'MODEL_CACHE_DISABLED', true ),
    ...
    'lighthouse' => [
        ...
        */
        ...
        'namespaces' => [
            ...
            'subscriptions' => 'WishKnish\\KnishIO\\GraphQL\\Subscriptions',
            'interfaces'    => 'WishKnish\\KnishIO\\GraphQL\\Interfaces',
            'unions'        => 'WishKnish\\KnishIO\\GraphQL\\Unions',
            'scalars'       => 'WishKnish\\KnishIO\\GraphQL\\Scalars',
            'directives'    => [
